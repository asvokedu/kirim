...
class SignalDetector:
    ...
    def _cancel_binance_order(self, symbol: str, order_id: int) -> Tuple[bool, str]:
        ...
        try:
            ...
            # PERBAIKAN: Tangani respons dengan lebih baik
    ...
    def cancel_order(self):
        ...
        try:
            ...
            # 2. Perbarui status di database - PERBAIKAN: gunakan status 3 (Canceled)
            update_success = self._update_order_status(
                order_id=order_id,
            ...
            # PERBAIKAN: Refresh data setelah perubahan
            self._refresh_open_orders_cache()

            return jsonify({
                'success': True,
                'msg': f"Order {order_id} canceled successfully"
            })
