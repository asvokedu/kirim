            ...
            try:
                ...
                for symbol in self.symbols:
                    ...
                    try:
                        ...
                        if recomendacion_id == "LONG" and btc_recommendation == "LONG" :  
                            signal = "LONG"
                        elif recomendacion_id == "LONG" and btc_index_val >= 0.20 :  
                            signal = "LONG"
                        elif recomendacion_id == "LONG" and btc_recommendation == "SHORT" :  
                            signal = "SHORT"
                        elif recomendacion_id == "LONG" and btc_index_val <= -0.10 :  
                            signal = "SHORT"
                        elif recomendacion_id == "SHORT" and btc_recommendation == "SHORT" :  
                            signal = "SHORT"    
                        elif recomendacion_id == "SHORT" and btc_recommendation == "LONG" :  
                            signal = "LONG"
                        elif recomendacion_id == "SHORT" and btc_index_val <= -0.10 :  
                            signal = "SHORT"
                        elif recomendacion_id == "SHORT" and btc_index_val >= 0.20 :  
                            signal = "LONG"
                        else:
                            signal = "HOLD"
