            ...
            try:
                ...
                for symbol in self.symbols:
                    ...
                    try:
                        ...
                        if recomendacion_id == 'LONG' and sp_score >= 6: score += 2
                        elif recomendacion_id == 'SHORT' and sp_score <= -4: score -= 2
                        elif recomendacion_id == 'HOLD': score = max(min(score, 3), -3)  # Batasi sinyal lemah
