    ...
    def _fetch_btc_price_index(self):
        ...
        try:
            with self.db_semaphore:
                ...
                if row and hasattr(row, 'price_index'):
            ...
            logger.error(f"Gagal mengambil BTC price index: {e}")
        finally:
            if conn:
                conn.close()
            ...
            try:
                ...
                for symbol in self.symbols:
                    ...
                    try:
                        ...
                        with self.data_lock:
                            btc_index = self.btc_price_index
                        ...
                        if score not in [-6, 6] and abs(score) <= 6:
                            ...
                            elif score == 6 and buy_liq_usd== 0 and sell_liq_usd== 0 and btc_index > 0.005 :
                                signal = "LONG"
