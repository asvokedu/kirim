                    ...
                    try:
                        ...
                        if score >= 4 and recomendacion_id == "LONG":
                            if btc_recommendation == "LONG" and btc_index_val > 0.20:
                                signal = "LONG"
                            elif btc_recommendation != "LONG" and btc_index_val > 0.20:
                                signal = "LONG"
                            elif btc_recommendation == "LONG" and btc_index_val <= -0.20:
                                signal = "LONG"    
                            elif btc_recommendation == "LONG" and btc_index_val <= -0.20:
                                ...
                                signal = "HOLD"      
                        elif score <= -4 and recomendacion_id == "SHORT":
                            if btc_recommendation == "SHORT" and btc_index_val <= -0.20:
                                signal = "SHORT"
                            elif btc_recommendation != "SHORT" and btc_index_val <= -0.20:
                                signal = "SHORT"
                            elif btc_recommendation == "SHORT" and btc_index_val >= 0.20:
                                signal = "LONG"
                            elif btc_recommendation == "SHORT" and btc_index_val < 0.20 and btc_index_val != -0:
                                signal = "HOLD"
                            else:
                                signal = "HOLD"
                        elif score <= -4 and recomendacion_id == "HOLD":
                            if btc_recommendation == "SHORT" and btc_index_val <= -0.20:
                                signal = "SHORT"
                            elif btc_recommendation != "SHORT" and btc_index_val <= -0.20:
                                signal = "SHORT"
