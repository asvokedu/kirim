            ...
            try:
                ...
                for symbol in self.symbols:
                    ...
                    try:
                        ...
                        if btc_recommendation == 'LONG' and btc_index_val > 0.25:
                            score += 2
                        elif btc_recommendation == 'SHORT' and btc_index_val < -0.25:
                            score -= 2
                        ...
                        if score >= 8:
                            ...
                            if buy_ratio > 60 and liq_sell_usd > 30000:
                                signal = 'LONG'
                        elif score <= -8:
                            signal = 'SHORT'
                        elif score <= -6:
                            if sell_ratio > 60 and liq_buy_usd > 30000:
                                signal = 'SHORT'
                        
                        # Filter volatilitas rendah (ATR)
                        if atr14 > 0:
                            atr_percent = (atr14 / mark_price) * 100
                            if atr_percent < 0.1:  # Volatilitas terlalu rendah
                                signal = 'HOLD'
                        ...
                        if order_book.get('bids') and order_book.get('asks'):
                            ...
                            spread_percent = (spread / mark_price) * 100
                            
                            if spread_percent > 0.1:  # Spread terlalu lebar
                                signal = 'HOLD'
